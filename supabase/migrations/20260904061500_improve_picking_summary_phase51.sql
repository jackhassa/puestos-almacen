...
-- ============================================================================
-- Puestos Almacen - FASE 5.1
-- Mejora UI Picking:
-- - contador de pausas del dia
-- - soporte del historial plegable en terminal
--
-- FASE 5 ya aplicada: no se modifica su migracion.
-- ============================================================================
...
begin
  if to_regprocedure('public.warehouse_get_picking_summary(text)') is null then
    raise exception 'No existe warehouse_get_picking_summary tras FASE 5.1.';
  end if;
end;
$$;
